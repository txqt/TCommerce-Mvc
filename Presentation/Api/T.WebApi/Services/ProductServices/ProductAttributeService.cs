...
namespace T.WebApi.Services.ProductServices
{
    ...
    public class ProductAttributeService : IProductAttributeService
    {
        ...
        public ProductAttributeService(IRepository<ProductAttribute> productAttributeRepository, IRepository<ProductAttributeMapping> productAttributeMappingRepository)
        {
